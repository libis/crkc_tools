...
exec("nohup sh reloadSort.sh > /www/libis/vol03/collectiveaccess/crkc_media/process_reload.out 2> /www/libis/vol03/collectiveaccess/crkc_media/process_reload.err < /dev/null &");
