...
while($o_tab_parser->nextRow()) {
	...
	if (substr(trim($vs_crkcObjectnr),0,2) == "PA" )
	{
...
// Read csv; line by line till end of file.
if (!$o_tab_parserAfbeeldingen->parse('/www/libis/html/ca_crkc/app/lib/ca/data/afbeeldingenPa.csv')) {
	die("Couldn't parse afbeeldingenPa.csv data\n");	
}
	
print "READING afbeeldingenPa.csv...\n";
