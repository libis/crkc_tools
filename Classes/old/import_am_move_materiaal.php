...
$t_list = new ca_lists();
if (!$t_list->load(array('list_code' => 'move_materiaal'))) {
	$t_list->setMode(ACCESS_WRITE);
	$t_list->set('list_code', 'move_materiaal');
	...
	$t_list->addLabel(array('name' => 'AM-MovE-materiaal'), $pn_en_locale_id, null, true);
}
