...
/*
*******************************
anderetrefwoord_lijst
*******************************
*/
print "IMPORTING ANDERETREFWOORD_LIJST\n";

$t_list->load(array('list_code' => 'anderTrefwoord_list')); 
...
print "READING new_anderetrefwoord.csv...\n";
...
if ($t_item = $t_list->addItem($vs_stijlen_naam, true, false, null, null, $vs_AATtermnummer,'', 4, 1, null)) {
	...
	if (!($t_item->addLabel(
		...
		print "ERROR: Could not add preferred label to andere_trefwoord_lijst ".$vs_stijlen_naam.": ".join("; ", $t_item->getErrors())."\n";
	}
}					
$vn_c++;
}
