...
if (!file_exists('/www/libis/html/ca_crkc/app/lib/ca/AmoveThes 2011-07.xml')) {
...
$t_list = new ca_lists();
if (!$t_list->load(array('list_code' => 'move_techniek'))) {
	$t_list->setMode(ACCESS_WRITE);
	$t_list->set('list_code', 'move_techniek');
	...
	$t_list->addLabel(array('name' => 'AM-MovE-techniek'), $pn_en_locale_id, null, true);
}
...
// create log file
$logFile = fopen("/www/libis/web/collectiveaccess/crkc_media/output.log", 'w') or die("can't open file");

// load voc_terms
$o_xml = new XMLReader();
$o_xml->open('/www/libis/html/ca_crkc/app/lib/ca/AmoveThes 2011-07.xml');
