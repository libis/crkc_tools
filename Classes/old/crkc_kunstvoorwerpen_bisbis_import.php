...
print "te doen {$vb_EigenaarInstelling} / {$vb_EigenaarPersoon} / {$vb_TypeRelatieTotObject} / {$vb_TypeVanZichBevinden} \n";
print "Eigenaar1 {$vs_EigenaarInstelling} / {$vs_EigenaarPersoon} \n";
...
*/
	if (($vn_BewaarplaatsTypeBevinden_id) == 2 ) {
...
print "Eigenaar2 {$vs_EigenaarInstelling} / {$vs_EigenaarPersoon} \n";
if (($vb_EigenaarInstelling) or ($vb_EigenaarPersoon)) {
...
//		'statusBeheerderDatum'		=>	$vs_Opmerking,
	...
	), 'statuutStatusEigenaarInfo', null);
}
/*
if (($vb_BeheerderInstelling) or ($vb_BeheerderPersoon)) {
	$t_object->addAttribute(array(
...
*/				
$vs_EigenaarInstelling = '';
$vs_EigenaarPersoon = '';
$vn_HuidigeStatusEigenaar = null;
$vn_StatuutStatusEigenaar = null;
$vs_StatuutOpmerking_Eigenaar = '';
$vs_Naam_EigenaarPersoon = '';
$vs_Naam_EigenaarInstelling = '';

print "Eigenaar3 {$vs_EigenaarInstelling} / {$vs_EigenaarPersoon} \n";
/*
...
*/
	...
	print "geen Eigenaar data - niks te doen \n ";
}
