...
//***************************************
//**** KUNSTVOORWERP_HAS_TREFWOORD  *****
//***************************************

print "IMPORTING kunstvoorwerp has trefwoord \n";
...
// Read csv; line by line till end of file.
if (!$o_tab_parser->parse('/www/libis/html/ca_crkc/app/lib/ca/data/trefwoorden_nog_opteladen.csv')) {
	die("Couldn't parse kunstvoorwerp_has_trefwoord.csv data\n");	
}
	
print "READING new_kunstvoorwerp_has_trefwoord.csv...\n";
...
while($o_tab_parser->nextRow()) {
	...
	print "creating trefwoord voor kunstvoorwerp ".$vn_Kunstvoorwerp_id.".".$vn_Term_id."  \n";
...
if ($vn_Term_waarde = $t_list->getItemIDFromListByItemValue('trefwoord_list', $vs_Term_waarde)) {
...
//----------------
	...
	print " Trefwoord  {$vs_Term_waarde} voor {$vn_Kunstvoorwerp_id} niet gevonden in anderTrefwoord_list -  skipping record \n";
...
print "END IMPORTING kunstvoorwerp_has_trefwoord \n";
