...
$t_list = new ca_lists();
if (!$t_list->load(array('list_code' => 'move_materiaal_new_2'))) {
        echo 'Kan lijst niet vinden, maken nieuwe aan';
	$t_list->setMode(ACCESS_WRITE);
	$t_list->set('list_code', 'move_materiaal_new_2');
	...
	$t_list->addLabel(array('name' => 'move-materiaal_new_2'), $pn_en_locale_id, null, true);
}
...
if (in_array('materiaal', $vs_termtype)) {
...
#hier moet probleem liggen		// Process used-for terms
					// ----------------------
